    ...
    private fun initNavigation() {
       ...
       /* mapboxNavigation.requestRoutes(
            RouteOptions.builder()
               ...
               // .accessToken(getString(R.string.mapbox_access_token))
                .coordinatesList(listOf(destination_one, destination_two))
                .profile(DirectionsCriteria.PROFILE_DRIVING)
                .approachesList(listOf(
...
*/
        ...
        //val route_one = DirectionsRoute.builder().
        ...
        val routeOptions = RouteOptions.builder()
           ...
           // .coordinatesList(listOf(originPoint, destination))
            .coordinatesList(listOf(destination_one,destination_two,destination_three,
                ...
                destination_8,destination_9,destination_10
                ))
